...
(function(){
    ...
    const setting =(function(){
        ...
        const result ={
            ...
            afterStr:String(param['afterStr'] || ""),
...
class Window_Info extends Window_Selectable{
    ...
    initialize(){
        ...
        const height = this.fittingHeight(setting.list.length);
    ...
    drawItem(index){
        ...
        this.drawText(value+setting.afterStr, rect.x+data.paddingX, rect.y, rect.width, 'right');
    }
};
Window_Info.needRefresh =false;
