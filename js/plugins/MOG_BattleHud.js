 ...
 *
 * @param Hud Space X
 * @desc Hud間の水平方向の間隔を設定します
 * @default 0
 *
 * @param Hud Space Y
 * @desc Hud間の垂直方向の間隔を設定します
 * @default 0
 *
 * @param Hud Slide X
 * @desc X軸をスライドさせます
...
Battle_Hud.prototype.create_face = function() {
	...
	// 衣装差分
	var costumeId = $gameVariables.value(this._battler._actorId + 30);
	this._face = new Sprite(ImageManager.loadBHud("Face_" + this._battler._actorId + "_" + costumeId));
