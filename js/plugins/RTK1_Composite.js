...
(function(_global) {
	...
	RTK.onReady(function(){
		...
		RTK.text("Get", "入手");
		RTK.text("Composite Workroom", "合成の作業台");
		RTK.text("Item Composite Workroom", "アイテム合成の作業台");
		RTK.text("Weapon Composite Workroom", "武器合成の作業台");
		RTK.text("Armor Composite Workroom", "防具合成の作業台");
		RTK.text("Custom Composite Workroom", "特別な合成の作業台");
