...
　　var Moghunter = Moghunter || {}; 	
	...
	Moghunter.v_actor_start[5] = ["P5_Start_01","P5_Start_02"];
	Moghunter.v_actor_start[6] = ["P6_Start_01","P6_Start_02"];
	Moghunter.v_actor_start[7] = ["P7_Start_01","P7_Start_02"];
	Moghunter.v_actor_start[8] = ["P8_Start_01","P8_Start_02"];
	// -----------------------------------------------------------------------
	// ACTOR - BATTLE TURN
	// -----------------------------------------------------------------------		
	Moghunter.v_actor_turn[1] = ["P1_Turn_01","P1_Turn_02","P1_Turn_03"];
	Moghunter.v_actor_turn[2] = ["P2_Turn_01","P2_Turn_02","P2_Turn_03"];
	Moghunter.v_actor_turn[3] = ["P3_Turn_01","P3_Turn_02","P3_Turn_03"];
	Moghunter.v_actor_turn[4] = ["P4_Turn_01","P4_Turn_02","P4_Turn_03"];
	Moghunter.v_actor_turn[5] = ["P5_Turn_01","P5_Turn_02","P5_Turn_03"];
	Moghunter.v_actor_turn[6] = ["P6_Turn_01","P6_Turn_02","P6_Turn_03"];
	Moghunter.v_actor_turn[7] = ["P7_Turn_01","P7_Turn_02","P7_Turn_03"];
	Moghunter.v_actor_turn[8] = ["P8_Turn_01","P8_Turn_02","P8_Turn_03"];
	// -----------------------------------------------------------------------
	...
	Moghunter.v_actor_default_action[7] = ["P7_Action_01","P7_Action_02","P7_Action_03"];
	...
	// ACTOR - ITEM
	// -----------------------------------------------------------------------	
	Moghunter.v_actor_item[1] = {1:["P1_Action_01","P1_Action_02","P1_Action_03"]};
	...
	Moghunter.v_actor_damage[7] = ["P7_Damage_01","P7_Damage_02","P7_Damage_03"];
	...
	Moghunter.v_actor_evaded[7] = ["P7_Evade_01"];
	Moghunter.v_actor_evaded[8] = ["P8_Evade_01"];
	// -----------------------------------------------------------------------
	// ACTOR - COUNTER
	// -----------------------------------------------------------------------		
	Moghunter.v_actor_counter[1] = ["P1_Action_02"];
	Moghunter.v_actor_counter[2] = ["P2_Action_02"];
	Moghunter.v_actor_counter[3] = ["P3_Action_02"];
	Moghunter.v_actor_counter[4] = ["P4_Action_02"];
	Moghunter.v_actor_counter[5] = ["P5_Action_02"];
	Moghunter.v_actor_counter[6] = ["P6_Action_02"];
	Moghunter.v_actor_counter[7] = ["P7_Action_02"];
	Moghunter.v_actor_counter[8] = ["P8_Action_02"];
	// -----------------------------------------------------------------------
	// ACTOR - REFLECTION
	// -----------------------------------------------------------------------		
	Moghunter.v_actor_reflection[1] = ["P1_Action_02"];
	Moghunter.v_actor_reflection[2] = ["P2_Action_02"];
	Moghunter.v_actor_reflection[3] = ["P3_Action_02"];
	Moghunter.v_actor_reflection[4] = ["P4_Action_02"];
	Moghunter.v_actor_reflection[5] = ["P5_Action_02"];
	Moghunter.v_actor_reflection[6] = ["P6_Action_02"];
	Moghunter.v_actor_reflection[7] = ["P7_Action_02"];
	Moghunter.v_actor_reflection[8] = ["P8_Action_02"];
	// -----------------------------------------------------------------------
	// ACTOR - RECOVER
	// -----------------------------------------------------------------------		
	...
	Moghunter.v_actor_recover[4] = ["P4_Recover_01","P4_Recover_02"];
	Moghunter.v_actor_recover[5] = ["P5_Recover_01","P5_Recover_02"];
	Moghunter.v_actor_recover[6] = ["P6_Recover_01","P6_Recover_02"];
	Moghunter.v_actor_recover[7] = ["P7_Recover_01","P7_Recover_02"];
	Moghunter.v_actor_recover[8] = ["P8_Recover_01","P8_Recover_02"];
	// -----------------------------------------------------------------------
	// ACTOR - DEAD
	// -----------------------------------------------------------------------		
	Moghunter.v_actor_dead[1] = ["P1_Dead_01","P1_Dead_02"];
	Moghunter.v_actor_dead[2] = ["P2_Dead_01","P2_Dead_02"];
	Moghunter.v_actor_dead[3] = ["P3_Dead_01","P3_Dead_02"];
	Moghunter.v_actor_dead[4] = ["P4_Dead_01","P4_Dead_02"];
	Moghunter.v_actor_dead[5] = ["P5_Dead_01","P5_Dead_02"];
	Moghunter.v_actor_dead[6] = ["P6_Dead_01","P6_Dead_02"];
	Moghunter.v_actor_dead[7] = ["P7_Dead_01","P7_Dead_02"];
	...
	Moghunter.v_actor_escape[7] = ["P7_Escape_01"];
	Moghunter.v_actor_escape[8] = ["P8_Escape_01"];
	// -----------------------------------------------------------------------
	// ACTOR - VICTORY
	// -----------------------------------------------------------------------		
	Moghunter.v_actor_victory[1] = ["P1_Victory_01","P1_Victory_02","P1_Victory_03"];
	Moghunter.v_actor_victory[2] = ["P2_Victory_01","P2_Victory_02","P2_Victory_03"];
	Moghunter.v_actor_victory[3] = ["P3_Victory_01","P3_Victory_02","P3_Victory_03"];
	Moghunter.v_actor_victory[4] = ["P4_Victory_01","P4_Victory_02","P4_Victory_03"];
	Moghunter.v_actor_victory[5] = ["P5_Victory_01","P5_Victory_02","P5_Victory_03"];
	Moghunter.v_actor_victory[6] = ["P6_Victory_01","P6_Victory_02","P6_Victory_03"];
	Moghunter.v_actor_victory[7] = ["P7_Victory_01","P7_Victory_02","P7_Victory_03"];
	Moghunter.v_actor_victory[8] = ["P8_Victory_01","P8_Victory_02","P8_Victory_03"];
	// -----------------------------------------------------------------------
	// ACTOR - LEVEL UP
	// -----------------------------------------------------------------------		
	Moghunter.v_actor_levelup[1] = ["P1_Levelup_01"];
	Moghunter.v_actor_levelup[2] = ["P2_Levelup_01"];
	Moghunter.v_actor_levelup[3] = ["P3_Levelup_01"];
	Moghunter.v_actor_levelup[4] = ["P4_Levelup_01"];
	Moghunter.v_actor_levelup[5] = ["P5_Levelup_01"];
	Moghunter.v_actor_levelup[6] = ["P6_Levelup_01"];
	Moghunter.v_actor_levelup[7] = ["P7_Levelup_01"];
	Moghunter.v_actor_levelup[8] = ["P8_Levelup_01"];
